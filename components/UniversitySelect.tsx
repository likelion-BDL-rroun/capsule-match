              ...
              <button className="univ-card-mobile" onClick={() => onSelect(uni)}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0, position: 'relative' }}>
                      {logoUrl ? (
                        <Image src={logoUrl} alt={uni.name} fill style={{ objectFit: 'contain' }} />
                      ) : (
